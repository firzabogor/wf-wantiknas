        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Jabatan</h6>
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            <li class="breadcrumb-item"><a href="<?php echo base_url('dashboard');?>"><i class="fas fa-home"></i></a></li>
                            <li class="breadcrumb-item active"><a href="<?php echo base_url('jabatan');?>">Jabatan</a></li>
                        </ol>
                    </nav>
                </div>
...
<div class="container-fluid mt--6">
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="table-responsive py-4">
                    <table class="table table-flush" id="jabatan" style="width:100%">
        ...
        <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="modal-title-default">Jabatan</h6>
    ...
    <script>
        ...
        function open_form(id = null){
            ...
            if(id == null){
                var link = "<?php echo base_url('jabatan/post'); ?>";
                $("#form-input").attr('action', link);
                $("#submit").html("Create");
            } else {
                var link = "<?php echo base_url('jabatan/put/'); ?>"+id;
                $("#form-input").attr('action', link);
                $("#submit").html("Update");
                $.ajax({
        ...
        function delete_jabatan(e,id){
            e.preventDefault();
            $.ajax({
                url:"<?php echo base_url('jabatan/delete/');?>"+id,
                type:'DELETE',
                success:function(data){
                    if(data == "success"){
                        table.ajax.reload();
        ...
        $(document).ready(function(){
            table = $('#jabatan').DataTable({
                ...
                "order": [[ 0, 'asc' ]],
                "ajax": {
                    "url": "<?php echo base_url('jabatan/datatables') ?>",
                    "type": "POST"
                },
                "deferRender": true,
                ...
                "columns": [
                    ...
                    { "render": function ( data, type, row ) {
                            var html  =`<div class="dropdown">
                                            <a style="height:12px" class="btn btn-sm btn-icon-only text-light" href="#" jabatan="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <i class="fas fa-ellipsis-h"></i>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="#" onclick="open_form(`+row.id+`)">Update</a>
                                                <a class="dropdown-item" href="#" onclick="delete_jabatan(event,`+row.id+`)">Delete</a>
                                            </div>
                                        </div>`;
                            return html
                        }
