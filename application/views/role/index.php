                ...
                <div class="col-lg-6 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item active"><a href="<?php echo base_url('role');?>">Role</a></li>
                        </ol>
                    </nav>
                </div>
...
<div class="container-fluid mt--6">
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="table-responsive py-4">
                    <table class="table table-flush" id="role" style="width:100%">
        ...
        <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="modal-title-default">Role</h6>
    ...
    <script>
        ...
        function open_form(id = null){
            ...
            if(id == null){
                var link = "<?php echo base_url('role/post'); ?>";
                $("#form-input").attr('action', link);
                $("#submit").html("Create");
            } else {
                var link = "<?php echo base_url('role/put/'); ?>"+id;
                $("#form-input").attr('action', link);
                $("#submit").html("Update");
                $.ajax({
                    url:"<?php echo base_url('role/get/');?>"+id,
                    type:'GET',
        ...
        $(document).ready(function(){
            table = $('#role').DataTable({
                ...
                "order": [[ 0, 'asc' ]],
                "ajax": {
                    "url": "<?php echo base_url('role/datatables') ?>",
                    "type": "POST"
                },
                "deferRender": true,
                    ...
                    { "render": function ( data, type, row ) {
                            var html  =`<div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                ...
                                                <a class="dropdown-item" href="#" onclick="delete_role(event,`+row.id+`)">Delete</a>
                                            </div>
                                        </div>`;
                            return html
                        }
