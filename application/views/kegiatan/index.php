    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          <a href="kegiatan/save" class="btn btn-sm btn-neutral">New</a>
  ...
  <div class="row">
      ...
      <script>
            ...
            function delete_kegiatan(e,no){
              ...
              $.ajax({
                url:base_url+'kegiatan/delete/'+no,
                type:'DELETE',
        ...
        function format ( d ) {
            ...
            return '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px; width:100%">'+
                '<tr>'+
                    '<td style="letter-spacing: 1px;font-weight: 600;font-size: .65rem;color:#8898aa;text-transform: uppercase;width: 20px;">Pukul</td>'+
                    '<td>'+d.pukul+'</td>'+
                '</tr>'+
                '<tr>'+
                ...
                '</tr>'+
                '<tr>'+
                    '<td style="letter-spacing: 1px;font-weight: 600;font-size: .65rem;color:#8898aa;text-transform: uppercase;width: 20px;">Tempat</td>'+
                    '<td>'+d.tempat+'</td>'+
                '</tr>'+
                '<tr>'+
                    '<td style="letter-spacing: 1px;font-weight: 600;font-size: .65rem;color:#8898aa;text-transform: uppercase;width: 20px;">Link Meeting</td>'+
                    '<td>'+d.link_meeting+'</td>'+
                '</tr>'+
                '<tr>'+
                    '<td style="letter-spacing: 1px;font-weight: 600;font-size: .65rem;color:#8898aa;text-transform: uppercase;width: 20px;">Pimpinan Rapat</td>'+
                    '<td>'+d.pimpinan_rapat+'</td>'+
                '</tr>'+
                '<tr>'+
                    '<td style="letter-spacing: 1px;font-weight: 600;font-size: .65rem;color:#8898aa;text-transform: uppercase;width: 20px;">Moderator</td>'+
                    '<td>'+d.moderator+'</td>'+
                '</tr>'+
            '</table>';
        }
        ...
        $(document).ready(function() {
            table = $('#example').DataTable({
              ...
              "ajax": {
                "url": "<?php echo base_url('kegiatan/view') ?>", // URL file untuk proses select datanya
                "type": "POST"
              },
              "deferRender": true,
              ...
              "columns": [
                    ...
                    { "data": "nama_kegiatan" },  // Tampilkan nama
                    { "data": "tipe_meeting" }, // Tampilkan telepon
                    { "data": "kategori_meeting" }, // Tampilkan alamat
                    { "data": "tribe" }, // Tampilkan alamat
                    { "data": "tanggal" }, // Tampilkan alamat
                    { "render": function ( data, type, row ) {
                      var html  =`<div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                      <a class="dropdown-item" href="`+baseurl+`kegiatan/update/`+row.no+`">Update</a>
                                      <a class="dropdown-item" href="#" onclick="delete_kegiatan(event,`+row.no+`)">Delete</a>
                                      <a class="dropdown-item" href="#" onclick="cetak_undangan(`+row.no+`)">Cetak Undangan</a>
                                    </div>
                                  </div>`;
                          return html
                      }
