                ...
                <div class="col-lg-6 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item active"><a href="<?php echo base_url('tag');?>">Tag</a></li>
                        </ol>
                    </nav>
                </div>
...
<div class="container-fluid mt--6">
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="table-responsive py-4">
                    <table class="table table-flush" id="tag" style="width:100%">
        ...
        <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="modal-title-default">Tag</h6>
    ...
    <script>
        ...
        function open_form(id = null){
            ...
            if(id == null){
                var link = "<?php echo base_url('tag/post'); ?>";
                $("#form-input").attr('action', link);
                $("#submit").html("Create");
            } else {
                var link = "<?php echo base_url('tag/put/'); ?>"+id;
                $("#form-input").attr('action', link);
                $("#submit").html("Update");
                $.ajax({
                    url:"<?php echo base_url('tag/get/');?>"+id,
                    type:'GET',
        ...
        function delete_tag(e,id){
            e.preventDefault();
            $.ajax({
                url:"<?php echo base_url('tag/delete/');?>"+id,
                type:'DELETE',
                success:function(data){
                    if(data == "success"){
                        table.ajax.reload();
        ...
        $(document).ready(function(){
            table = $('#tag').DataTable({
                ...
                "order": [[ 0, 'asc' ]],
                "ajax": {
                    "url": "<?php echo base_url('tag/datatables') ?>",
                    "type": "POST"
                },
                "deferRender": true,
                ...
                "columns": [
                    ...
                    { "render": function ( data, type, row ) {
                            var html  =`<div class="dropdown">
                                            <a style="height:12px" class="btn btn-sm btn-icon-only text-light" href="#" tag="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <i class="fas fa-ellipsis-h"></i>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="#" onclick="open_form(`+row.id+`)">Update</a>
                                                <a class="dropdown-item" href="#" onclick="delete_tag(event,`+row.id+`)">Delete</a>
                                            </div>
                                        </div>`;
                            return html
                        }
