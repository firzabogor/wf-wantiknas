    ...
    <div class="row">
        <div class="col">
            <div class="card">
              ...
              <!-- Card body -->
              <div class="card-body">
                <form class="needs-validation" id="update_narasumber" method="POST" action="<?php echo base_url();?>narasumber/change/<?php echo $no ?>" novalidate>
                  <div class="form-row">
                    <div class="col-md-6 mb-3">
                      <label class="form-control-label" for="nama">Nama Lengkap</label>
                      <input type="text" class="form-control" value="<?php echo $nama;?>" id="nama" name="nama" placeholder="Nama Lengkap" required>
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" class="form-control" value="<?php echo $foto;?>" id="foto" name="foto" placeholder="Link Foto" required>
                      <div class="valid-feedback">
                        Looks good!
                      </div>
                    </div>
                  ...
                  <div class="form-row">
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" class="form-control" value="<?php echo $telepon;?>" id="telepon" placeholder="No.Telepon" name="telepon" required>
                      <div class="valid-feedback">
                        Looks good!
                      </div>
                    </div>
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" class="form-control" value="<?php echo $email;?>" id="email" placeholder="Email" name="email" required>
                      <div class="valid-feedback">
                        Looks good!
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div id="deskripsi" style="height:150px">
                      <?php echo $deskripsi;?>
                    </div>
                  </div>
      ...
      <script>
        ...
        $("#update_narasumber").on("submit",function(){
