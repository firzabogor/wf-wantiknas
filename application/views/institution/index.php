                ...
                <div class="col-lg-6 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item active"><a href="<?php echo base_url('instansi');?>">Instansi</a></li>
                        </ol>
                    </nav>
                </div>
                <div class="col-lg-6 col-5 text-right">
                    <a href="<?php echo base_url('instansi/form');?>" class="btn btn-sm btn-neutral">New</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid mt--6">
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="table-responsive py-4">
                    <table class="table table-flush" id="instansi" style="width:100%">
    ...
    <script>
        ...
        function delete_instansi(e,id){
            e.preventDefault();
            $.ajax({
                url:"<?php echo base_url('instansi/delete/');?>"+id,
                type:'DELETE',
        ...
        $(document).ready(function(){
            table = $('#instansi').DataTable({
                ...
                "order": [[ 0, 'asc' ]],
                "ajax": {
                    "url": "<?php echo base_url('instansi/datatables') ?>",
                    "type": "POST"
                },
                "deferRender": true,
                    ...
                    { "render": function ( data, type, row ) {
                            var html  =`<div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="<?php echo base_url('instansi/update/')?>`+row.id+`">Update</a>
                                                <a class="dropdown-item" href="#" onclick="delete_instansi(event,`+row.id+`)">Delete</a>
                                            </div>
                                        </div>`;
                            return html
                        }
